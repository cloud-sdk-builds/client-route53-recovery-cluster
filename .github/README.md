...
[`@aws-sdk/client-route53-recovery-cluster`](https://www.npmjs.com/package/@aws-sdk/client-route53-recovery-cluster/v/3.1091.0).
...
- @aws-sdk/client-route53-recovery-cluster v3.1091.0 - [https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-cluster&version=3.1091.0](https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-cluster&version=3.1091.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-cluster@3.1091.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vB10MSvaAQI4835pHyChDm5jUbg+1AAmdL+lClmbsN2+nkvtTY2fyWRjxXbJQzaw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53-recovery-cluster": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-cluster@3.1091.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-cluster@3.1091.0/index.min.mjs": "sha384-vB10MSvaAQI4835pHyChDm5jUbg+1AAmdL+lClmbsN2+nkvtTY2fyWRjxXbJQzaw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53-recovery-cluster/blob/refs/tags/3.1091.0/LICENSE
```
